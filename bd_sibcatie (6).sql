...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-07-2018 a las 21:15:02
...
(1, 1, 1, 1, 1, '2018-06-18', 'cXYsUTkhuItuJmSyldcl', '1', 'MTMdF0ewFmlKGAT', 1, 1, 1, 1, 1, 1, 1, 0, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
--
ALTER TABLE `reino`
  MODIFY `idReino` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
