...
(1, 'T3KkVPXfT8', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam id tristique enim, vel venenatis erat.'),
...
--
ALTER TABLE `epiteto`
  MODIFY `idEpiteto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `estadosalud`
--
ALTER TABLE `estadosalud`
  MODIFY `idEstadoSalud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `familia`
--
ALTER TABLE `familia`
  MODIFY `idFamilia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT de la tabla `forma`
--
ALTER TABLE `forma`
  MODIFY `idForma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `planta`
  MODIFY `idPlanta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `tipohoja`
  MODIFY `idTipoHoja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
